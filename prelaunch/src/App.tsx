...
export default function App() {
  ...
  // Show landing page
  if (showLanding) {
    return <LandingPage onGetStarted={handleGoToPreLaunch} />;
  }

  // Show pre-launch page
  if (showPreLaunch) {
          ...
          <div className="max-w-full mx-auto relative">
            <div className="flex items-center gap-4 mb-2">
              ...
              <div className="flex-1 h-2 bg-gray-300 rounded-full">
                <div
                  style={{
                    width: `${(["brand-info", "preview", "what-use"].indexOf(
                      activeSection
                    ) +
                      1) *
                      33.33
              ...
              {[
                ...
                return (
                  <div key={step.id} className="flex items-center gap-2">
                    <div
                      className={`w-2 h-2 rounded-full transition-colors duration-300 ${isCompleted || isCurrent ? "bg-black" : "bg-gray-300"
                        }`}
                    />
                    <span
                      style={{
                      ...
                      className={`text-xs transition-all duration-300 px-3 py-1 rounded-full ${isCurrent ? "font-semibold" : "text-gray-500"
                        }`}
                    >
                      {step.label}
                    </span>
